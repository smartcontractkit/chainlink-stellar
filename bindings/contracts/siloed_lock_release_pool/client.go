...
func (c *SiloedLockReleasePoolClient) GetFee(ctx context.Context, destChainSelector uint64, amount *big.Int, requestedFinality uint32, tokenArgs []byte) (*PoolFeeResult, error) {
	args := []xdr.ScVal{
...
func (c *SiloedLockReleasePoolClient) Upgrade(ctx context.Context, newWasmHash [32]byte) error {
	args := []xdr.ScVal{
...
func (c *SiloedLockReleasePoolClient) Initialize(ctx context.Context, owner string, token string, tokenDecimals uint32, router string, rampRegistry string, rmnProxy string) error {
	args := []xdr.ScVal{
		scval.AddressToScVal(owner),
...
func (c *SiloedLockReleasePoolClient) LockOrBurn(ctx context.Context, caller string, input LockOrBurnIn, requestedFinality uint32, tokenArgs []byte) (*LockOrBurnOut, error) {
	args := []xdr.ScVal{
...
func (c *SiloedLockReleasePoolClient) GetFeeAdmin(ctx context.Context) (*string, error) {
	args := []xdr.ScVal{}
...
func (c *SiloedLockReleasePoolClient) SetFeeAdmin(ctx context.Context, feeAdmin string) error {
	args := []xdr.ScVal{
...
func (c *SiloedLockReleasePoolClient) GetTokenTransferFeeConfig(ctx context.Context, destChainSelector uint64) (*TokenTransferFeeConfig, error) {
	args := []xdr.ScVal{
		scval.Uint64ToScVal(destChainSelector),
	}
...
func (c *SiloedLockReleasePoolClient) ApplyTokenFeeConfigUpdates(ctx context.Context, adds []TokenTransferFeeConfigArgs, disables []uint64) error {
	args := []xdr.ScVal{
		scval.StructSliceToScVal(adds),
...
func (c *SiloedLockReleasePoolClient) WaitForTokenFeeCfgDeletedEvent(ctx context.Context, startLedger uint32, timeout time.Duration, filter func(*TokenFeeCfgDeletedEvent) bool) (*TokenFeeCfgDeletedEvent, error) {
	startTime := time.Now()
	ticker := time.NewTicker(2 * time.Second)
	defer ticker.Stop()
...
func (c *SiloedLockReleasePoolClient) WaitForTokenFeeCfgUpdatedEvent(ctx context.Context, startLedger uint32, timeout time.Duration, filter func(*TokenFeeCfgUpdatedEvent) bool) (*TokenFeeCfgUpdatedEvent, error) {
	startTime := time.Now()
	ticker := time.NewTicker(2 * time.Second)
	defer ticker.Stop()
