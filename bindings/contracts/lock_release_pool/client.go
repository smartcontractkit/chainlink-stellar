...
func (c *LockReleasePoolClient) LockOrBurn(ctx context.Context, onRamp string, input LockOrBurnIn, requestedFinality uint32) (*LockOrBurnOut, error) {
	args := []xdr.ScVal{
...
func (c *LockReleasePoolClient) ReleaseOrMint(ctx context.Context, offRamp string, input ReleaseOrMintIn, requestedFinality uint32) (*ReleaseOrMintOut, error) {
	args := []xdr.ScVal{
