...
func (c *LockReleasePoolClient) GetFee(ctx context.Context, destChainSelector uint64, amount *big.Int, requestedFinality uint32, tokenArgs []byte) (*PoolFeeResult, error) {
	args := []xdr.ScVal{
...
func (c *LockReleasePoolClient) Upgrade(ctx context.Context, newWasmHash [32]byte) error {
	args := []xdr.ScVal{
...
func (c *LockReleasePoolClient) LockOrBurn(ctx context.Context, caller string, input LockOrBurnIn, requestedFinality uint32, tokenArgs []byte) (*LockOrBurnOut, error) {
	args := []xdr.ScVal{
...
func (c *LockReleasePoolClient) GetFeeAdmin(ctx context.Context) (*string, error) {
	args := []xdr.ScVal{}
...
func (c *LockReleasePoolClient) GetRmnProxy(ctx context.Context) (*string, error) {
	args := []xdr.ScVal{}
...
func (c *LockReleasePoolClient) SetFeeAdmin(ctx context.Context, feeAdmin string) error {
	args := []xdr.ScVal{
...
func (c *LockReleasePoolClient) AddRemotePool(ctx context.Context, remoteChainSelector uint64, remotePoolAddress []byte) error {
	args := []xdr.ScVal{
		scval.Uint64ToScVal(remoteChainSelector),
...
func (c *LockReleasePoolClient) GetRemotePools(ctx context.Context, remoteChainSelector uint64) ([][]byte, error) {
	args := []xdr.ScVal{
		scval.Uint64ToScVal(remoteChainSelector),
	}
...
func (c *LockReleasePoolClient) RemoveRemotePool(ctx context.Context, remoteChainSelector uint64, remotePoolAddress []byte) error {
	args := []xdr.ScVal{
		scval.Uint64ToScVal(remoteChainSelector),
		scval.BytesToScVal(remotePoolAddress),
	}
...
func (c *LockReleasePoolClient) WithdrawFeeTokens(ctx context.Context, caller string, feeTokens []string, recipient string) error {
	args := []xdr.ScVal{
		scval.AddressToScVal(caller),
...
func (c *LockReleasePoolClient) SetRateLimitConfig(ctx context.Context, caller string, remoteChainSelector uint64, outboundConfig RateLimitConfig, inboundConfig RateLimitConfig, fastFinality bool) error {
	args := []xdr.ScVal{
		scval.AddressToScVal(caller),
		scval.Uint64ToScVal(remoteChainSelector),
...
func (c *LockReleasePoolClient) GetTokenTransferFeeConfig(ctx context.Context, destChainSelector uint64) (*TokenTransferFeeConfig, error) {
	args := []xdr.ScVal{
		scval.Uint64ToScVal(destChainSelector),
	}
...
func (c *LockReleasePoolClient) ApplyTokenFeeConfigUpdates(ctx context.Context, adds []TokenTransferFeeConfigArgs, disables []uint64) error {
	args := []xdr.ScVal{
		scval.StructSliceToScVal(adds),
...
func (c *LockReleasePoolClient) WaitForRemotePoolAddedEvent(ctx context.Context, startLedger uint32, timeout time.Duration, filter func(*RemotePoolAddedEvent) bool) (*RemotePoolAddedEvent, error) {
	startTime := time.Now()
	ticker := time.NewTicker(2 * time.Second)
	defer ticker.Stop()
...
func (c *LockReleasePoolClient) WaitForLockBoxConfiguredEvent(ctx context.Context, startLedger uint32, timeout time.Duration, filter func(*LockBoxConfiguredEvent) bool) (*LockBoxConfiguredEvent, error) {
	startTime := time.Now()
	ticker := time.NewTicker(2 * time.Second)
	defer ticker.Stop()
...
func (c *LockReleasePoolClient) WaitForRemotePoolRemovedEvent(ctx context.Context, startLedger uint32, timeout time.Duration, filter func(*RemotePoolRemovedEvent) bool) (*RemotePoolRemovedEvent, error) {
	startTime := time.Now()
	ticker := time.NewTicker(2 * time.Second)
	defer ticker.Stop()
...
func (c *LockReleasePoolClient) WaitForTokenFeeCfgDeletedEvent(ctx context.Context, startLedger uint32, timeout time.Duration, filter func(*TokenFeeCfgDeletedEvent) bool) (*TokenFeeCfgDeletedEvent, error) {
	startTime := time.Now()
	ticker := time.NewTicker(2 * time.Second)
	defer ticker.Stop()
...
func (c *LockReleasePoolClient) WaitForTokenFeeCfgUpdatedEvent(ctx context.Context, startLedger uint32, timeout time.Duration, filter func(*TokenFeeCfgUpdatedEvent) bool) (*TokenFeeCfgUpdatedEvent, error) {
	startTime := time.Now()
	ticker := time.NewTicker(2 * time.Second)
	defer ticker.Stop()
