package advanced_pool_hooks_test
...
import (
	...
	"github.com/smartcontractkit/chainlink-stellar/deployment/operations/advanced_pool_hooks"
...
func TestUpgrade_operation(t *testing.T) {
	...
	var hash [32]byte
	hash[0] = 0xAB
	_, err := cldfops.ExecuteOperation(operationstest.NewBundle(t), advanced_pool_hooks.Upgrade, deps, advanced_pool_hooks.UpgradeInput{
		ContractID:  cid,
		NewWasmHash: hash,
	})
