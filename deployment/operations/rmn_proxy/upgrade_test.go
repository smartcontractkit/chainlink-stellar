...
import (
	...
	"github.com/smartcontractkit/chainlink-stellar/deployment/operations/rmn_proxy"
...
func TestUpgrade_operation(t *testing.T) {
	...
	var hash [32]byte
	hash[0] = 0xAB
	_, err := cldfops.ExecuteOperation(operationstest.NewBundle(t), rmn_proxy.Upgrade, deps, rmn_proxy.UpgradeInput{
		ContractID:  cid,
		NewWasmHash: hash,
	})
