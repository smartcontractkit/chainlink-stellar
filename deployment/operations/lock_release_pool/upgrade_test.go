package lock_release_pool_test
...
import (
	...
	"github.com/smartcontractkit/chainlink-stellar/deployment/operations/lock_release_pool"
...
func TestUpgrade_operation(t *testing.T) {
	...
	var hash [32]byte
	hash[0] = 0xAB
	_, err := cldfops.ExecuteOperation(operationstest.NewBundle(t), lock_release_pool.Upgrade, deps, lock_release_pool.UpgradeInput{
		ContractID:  cid,
		NewWasmHash: hash,
	})
