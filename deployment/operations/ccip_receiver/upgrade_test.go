...
import (
	...
	"github.com/smartcontractkit/chainlink-stellar/deployment/operations/ccip_receiver"
...
func TestUpgrade_operation(t *testing.T) {
	...
	var hash [32]byte
	hash[0] = 0xAB
	_, err := cldfops.ExecuteOperation(operationstest.NewBundle(t), ccip_receiver.Upgrade, deps, ccip_receiver.UpgradeInput{
		ContractID:  cid,
		NewWasmHash: hash,
	})
