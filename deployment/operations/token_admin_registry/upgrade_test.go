package token_admin_registry_test
...
import (
	...
	"github.com/smartcontractkit/chainlink-stellar/deployment/operations/token_admin_registry"
)
...
func TestUpgrade_operation(t *testing.T) {
	...
	var hash [32]byte
	hash[0] = 0xAB
	_, err := cldfops.ExecuteOperation(operationstest.NewBundle(t), token_admin_registry.Upgrade, deps, token_admin_registry.UpgradeInput{
		ContractID:  cid,
		NewWasmHash: hash,
	})
