...
import (
	...
	"github.com/smartcontractkit/chainlink-stellar/deployment/operations/rmn_remote"
...
func TestUpgrade_operation(t *testing.T) {
	...
	var hash [32]byte
	hash[0] = 0xAB
	_, err := cldfops.ExecuteOperation(operationstest.NewBundle(t), rmn_remote.Upgrade, deps, rmn_remote.UpgradeInput{
		ContractID:  cid,
		NewWasmHash: hash,
	})
