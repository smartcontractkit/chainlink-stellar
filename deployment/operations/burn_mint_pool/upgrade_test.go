...
import (
	...
	"github.com/smartcontractkit/chainlink-stellar/deployment/operations/burn_mint_pool"
...
func TestUpgrade_operation(t *testing.T) {
	...
	var hash [32]byte
	hash[0] = 0xAB
	_, err := cldfops.ExecuteOperation(operationstest.NewBundle(t), burn_mint_pool.Upgrade, deps, burn_mint_pool.UpgradeInput{
		ContractID:  cid,
		NewWasmHash: hash,
	})
