...
#[soroban_sdk::contractevent(topics = ["ramp_reg_OnRampSet"])]
#[derive(Debug, Clone, Eq, PartialEq, Ord, PartialOrd)]
pub struct OnRampSetEvent {
    pub dest_chain_selector: u64,
    pub onramp: soroban_sdk::Address,
}
#[soroban_sdk::contractevent(topics = ["ramp_reg_OffRampAdded"])]
#[derive(Debug, Clone, Eq, PartialEq, Ord, PartialOrd)]
pub struct OffRampAddedEvent {
    pub source_chain_selector: u64,
    pub offramp: soroban_sdk::Address,
}
#[soroban_sdk::contractevent(topics = ["ramp_reg_OnRampRemoved"])]
#[derive(Debug, Clone, Eq, PartialEq, Ord, PartialOrd)]
pub struct OnRampRemovedEvent {
    pub dest_chain_selector: u64,
}
#[soroban_sdk::contractevent(topics = ["ramp_reg_OffRampRemoved"])]
#[derive(Debug, Clone, Eq, PartialEq, Ord, PartialOrd)]
