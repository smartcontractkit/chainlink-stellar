...
replace (
	...
	// grafana/dskit (pulled in transitively by grafana/loki v3.7.x, used by
	// chainlink-testing-framework/wasp) declares this replace against grafana's
	// memberlist fork, which adds NodeState/NodeSelection/PushPullNodes used by
