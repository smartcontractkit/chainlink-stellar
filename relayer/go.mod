module github.com/smartcontractkit/chainlink-stellar/relayer
...
replace (
	// gogo/protobuf generate tag is incompatible with newer protobuf; chainlink-common
	// transitively pulls it, so mirror the root module's replace.
